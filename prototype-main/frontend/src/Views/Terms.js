    ...
    <Box>
      ...
      <Box paddingTop={3}>
        <Container maxWidth="flex">
          <Typography variant="h3" align="center" paddingBottom={5}>
            AirParts Terms and Conditions
          </Typography>
          <Typography variant="body1" paddingLeft={10} paddingRight={10} paddingBottom={3}>
            ...
            with our privacy policy govern AirParts’s relationship with you in relation to this
            website. If you disagree with any part of these terms and conditions, please do not use
            our website. The term ‘AirParts’ or ‘us’ or ‘we’ refers to the owner of the website. The
            term ‘you’ refers to the user or viewer of our website.
          </Typography>
          <Typography paddingLeft={10} paddingRight={10}>
            The Use of this website is subject to the following terms of use:
          </Typography>
          <Typography variant="body1" paddingLeft={10} paddingRight={10}>
            <ul>
              <li>
              ...
              <li>
                This website uses cookies to monitor browsing preferences. If you do allow cookies
